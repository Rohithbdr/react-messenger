    ...
    render(){
        ...
        <div className='inbox-container'>
            <div className='user-profile'>
                <img src='https://i.ibb.co/mt8VfTk/dummy-profile-pic.jpg ' alt='profile picture' className='profile-picture'/>
                <div className='profile-name-details'>
                    <p className='profile-name'>Rohith Bandaru</p>
                    <p className='profile-tag'>@Rohith</p>
                </div>                                               
            </div>            
